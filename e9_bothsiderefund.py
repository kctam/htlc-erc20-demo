...
htlccontractid = input("Input Alice's USD contract ID: ")

nonce = w3.eth.getTransactionCount(alice)
tx = htlcerc20_contract.functions.refund(
  htlccontractid
).buildTransaction({
  'gas': 700000,
  'from': alice,
...
htlccontractid = input("Input Bob's EUR contract ID: ")
